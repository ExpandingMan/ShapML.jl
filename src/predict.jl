...
function _predict(;reference::DataFrame, data_predict::DataFrame, model, predict_function::Function,
                  n_features::Integer, n_target_features::Integer, n_instances_explain::Integer,
                  sample_size::Integer, precision::Union{Integer, Nothing},
